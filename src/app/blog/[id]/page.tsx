  ...
  if (!post) {
    return (
      <article className="bg-white rounded-lg shadow-lg p-4 mx-auto">
        <h1 className="text-4xl font-bold mb-2">Default {params.id}</h1>
        <p className="text-lg font-light">Description: Default</p>
        ...
        <div className="flex justify-between mt-5">
          <div className="flex items-center">
            ...
            <p className="text-lg">Author: Default</p>
          </div>
          <div className="flex items-center">
            {/* <img src="/icons/calendar-alt-solid.svg" className="w-10 h-10 mr-3" alt="calendar icon" /> */}
            <p className="text-lg">Date: {new Date().toString()}</p>
          </div>
        </div>
      </article>
    );
